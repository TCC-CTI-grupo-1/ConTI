    ...
    <div id="home" className="flex-container full-screen-size">
            ...
            <div className="container">
                ...
                <div className="content aboutUs">
                    ...
                    <h1>O Projeto</h1>
                    <h3>O ConTI nasce do desenvolvimento de um trabalho de conclusão de curso de informática. Sua ideia central é democratizar o conhecimento, tornando o acesso ao cursinho preparatório para o vestibulinho do Colégio Técnico Industrial Prof. Isaac Portal Roldan acessível a todos, sem distinção de condições financeiras. Valorizamos a instituição e acreditamos na importância de oferecer oportunidades educacionais para todos os interessados.</h3>
                    <br></br>
                    <h2>Visão</h2>
                    <h3>Reconhecimento nacional como plataforma estudantil para preparação de vestibulares em geral e o vestibulinho do Colégio Técnico Industrial Prof Isaac Portal Roldán.</h3>
                    <br></br> 
                    <h2>Missão</h2>
                    <h3>Proporcionar o acesso a uma plataforma de estudos para auxiliar os estudos do aluno que deseja ingressar no Colégio Técnico Industrial Prof Isaac Portal Roldán.</h3>
