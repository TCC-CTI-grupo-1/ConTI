...
const NewTestIcon = ({iconColor='black', onIconClick, backgroundTransparent=false}:Props) => {
    ...
    return(
        ...
        onClick={onIconClick}>
        {color == 'white' && !backgroundTransparent && <rect width="40" height="40" rx="5" fill="#0066FF"/>}
